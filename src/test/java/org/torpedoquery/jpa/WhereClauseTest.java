...
public class WhereClauseTest {
    ...
    public void test_gte_primitive() {
        ...
        assertEquals("select entity_0 from Entity entity_0 where entity_0.primitiveInt >= :primitiveInt_1", select.getQuery());
    ...
    public void test_in_values() {
        ...
        assertEquals("select entity_0 from Entity entity_0 where entity_0.primitiveInt in ( :primitiveInt_1 )", select.getQuery());
    ...
    public void test_notIn_values() {
        ...
        assertEquals("select entity_0 from Entity entity_0 where entity_0.primitiveInt not in ( :primitiveInt_1 )", select.getQuery());
    ...
    public void test_subSelect_with_gt() {
        ...
        assertEquals("select entity_0 from Entity entity_0 where entity_0.integerField > ( select avg(entity_1.integerField) from Entity entity_1 )",
                select.getQuery());
    ...
    public void test_subSelect_with_gt_and_params() {
        ...
        assertEquals("select entity_0 from Entity entity_0 where entity_0.integerField > ( select avg(entity_1.integerField) from Entity entity_1 where entity_1.code = :code_2 )",
                select.getQuery());
    ...
    public void test_subSelect_in_select_clause() {
        ...
        Entity from = from(Entity.class);
        Query<Object[]> select = select(from.getName(), select(max(subSelect.getIntegerField())));

        assertEquals("select entity_0.name, ( select max(entity_1.integerField) from Entity entity_1 ) from Entity entity_0 ",
                select.getQuery());
    ...
    public void test_size() {
        ...
        assertEquals("select entity_0 from Entity entity_0 where entity_0.subEntities.size > :subEntities_1", select.getQuery());
    }
