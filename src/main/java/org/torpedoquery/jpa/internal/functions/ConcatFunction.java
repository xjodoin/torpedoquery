...
public class ConcatFunction<T> implements ComparableFunction<T> {
	...
	public String createQueryFragment(AtomicInteger incrementor) {
		...
		stringBuilder.append("concat(").append(first.createQueryFragment(incrementor));
	 ...
	 * <p>addSelector.</p>
	 *
	 * @param selector a {@link Selector} object.
	 */
	 ...
	 * <p>setQuery.</p>
	 *
	 * @param proxy a {@link TorpedoProxy} object.
	 */
