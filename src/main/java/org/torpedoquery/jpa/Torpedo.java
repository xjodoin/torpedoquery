...
import org.torpedoquery.jpa.internal.joins.*;
...
public class Torpedo extends TorpedoFunction {
     ...
     * @param <T>    a T object.
     */
    public static <T> JoinBuilder<T> innerJoinFetch(Class<T> toJoin) {
        return new InnerJoinFetchBuilder<>(toJoin, getTorpedoMethodHandler());
    }
     ...
     * @param <T>    a T object.
     */
    public static <T> JoinBuilder<T> leftJoinFetch(Class<T> toJoin) {
        return new LeftJoinFetchBuilder<>(toJoin, getTorpedoMethodHandler());
    }
